...
const Character = () => {
    const { character, loading, fetchCharacter } = useContext(CharacterContext);

    const params = useParams();

    useEffect(() => {
        fetchCharacter(params.char_id);
    }, []);
    ...
    return (
        <div className="grid grid-cols-2 container mx-auto px-24 mt-36 justify-center" style={{ height: 45 + 'rem' }}>
            <img src={character.img} className="h-4/6 w-10/12 hover:scale-105 transition duration-300" />
            <div className="mt-12">
